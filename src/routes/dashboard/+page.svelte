...
<div class="content">
	...
	<div class="dashboard">
		<div class="stats">
			...
			<div class="scrollbar">
				<div class="substats">
					<h3>Ranking: <div class="right">#1</div></h3>
		...
		<div class="stats">
			...
			<div class="scrollbar">
				<div class="substats">
					<h3>Ranking: <div class="right">#1</div></h3>
					<h3>Total Quests Completed: <div class="right">{userState.user?.points}</div></h3>
					<h3 class="taut">↪ Ranking: <div class="right">#1</div></h3>
					<h3 class="taut">↪ Past Month: <div class="right">+{userState.user?.points}</div></h3>
					<h3 class="taut">↪ Past Year: <div class="right">+{userState.user?.points}</div></h3>
					<h3>Total Verified Locations Marked: <div class="right">{userState.user?.points}</div></h3>
					<h3 class="taut">↪ Ranking: <div class="right">#1</div></h3>
					<h3 class="taut">↪ Past Month: <div class="right">+{userState.user?.points}</div></h3>
					<h3 class="taut">↪ Past Year: <div class="right">+{userState.user?.points}</div></h3>
					<h3>Total Reviews Left: <div class="right">{userState.user?.points}</div></h3>
					<h3 class="taut">↪ Ranking: <div class="right">#1</div></h3>
					<h3 class="taut">↪ Past Month: <div class="right">+{userState.user?.points}</div></h3>
					<h3 class="taut">↪ Past Year: <div class="right">+{userState.user?.points}</div></h3>
